                ...
                <div className="max-w-6xl mx-auto px-4 min-h-screen max-md:w-screen max-md:overflow-hidden pt-32 md:pt-26 flex items-center justify-center">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
                        <div className="text-left">
                            ...
                            >
                                Engineering, Construction & Cost Management <br />
                                <span className="bg-clip-text text-transparent bg-linear-to-r from-[#F37335] to-[#E05920]">
                                    for Reliable Project Delivery in Nigeria
                                </span>
                            </motion.h1>
                            ...
                            >
                                WillTech Engineering Ltd supports private developers, communities, organisations and public institutions to plan, cost and deliver projects with clarity and control.
                            </motion.p>
                            ...
                            >
                                <div className="flex items-center gap-2 p-2 px-3 sm:px-6.5 hover:bg-orange-200/40 transition-colors">
                                    ...
                                    <div>
                                        <div className="text-gray-900 font-semibold">Technical Excellence</div>
                                ...
                                <div className="flex items-center gap-2 p-2 px-3 sm:px-6.5 hover:bg-orange-200/40 transition-colors">
                                    ...
                                    <div>
                                        <div className="text-gray-900 font-semibold">Cost Discipline</div>
                                        <div className="text-xs text-gray-600">
