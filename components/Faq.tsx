                ...
                <div className="space-y-3">
                    {faqData.map((faq, i) => (
                        <motion.details
                            ...
                            className="group bg-orange-50/60 rounded-xl select-none border border-orange-200/60"
                        >
                            <summary className="flex items-center justify-between p-4 cursor-pointer">
                                <h4 className="font-medium text-gray-900">{faq.question}</h4>
                                <ChevronDownIcon className="w-5 h-5 text-gray-700 group-open:rotate-180 transition-transform" />
                            </summary>
                            <p className="p-4 pt-0 text-sm text-gray-700 leading-relaxed">
                                {faq.answer}
                            </p>
                        </motion.details>
                    ))}
